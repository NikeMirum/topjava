...
public class MealsUtil {
    ...
    public static Collection<MealTo> getWithExceeding(Collection<Meal> mealList, int caloriesDailyLimit) {
        return filteredByStreams(mealList, LocalTime.MIN, LocalTime.MAX, caloriesDailyLimit);
    }
